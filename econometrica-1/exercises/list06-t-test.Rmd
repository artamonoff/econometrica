...
<span style="color: blue">Уровень значимости `r 100*sign.level`%</span>. Проведите результаты неробастного и робастного t-тест.
...
Проведите результаты неробастного и робастного t-тест.
Вычислите тестовую статистику и критическое значение.
**Ответ округлите до двух десятичных знаков.**
