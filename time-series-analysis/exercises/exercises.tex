...
\begin{itemize}
	\item первая разность 3-месячной ставки (treasury bill)
	\item первая разность 6-месячной ставки (treasury bill)
	\item первая разность 10-летней ставки (treasury securities  with constant maturity)
\end{itemize}
Сформируйте многомерный ряд и
\begin{enumerate}
	\item Подгоните модели VAR(1), VAR(2), VAR(3) и постройте прогноз на 10 периодов
